<?php
    ...
    if(isset($_POST['username'])){
        ...
        $insert = mysqli_query($koneksi, "INSERT INTO user(namauser,username,password,role) VALUES('$namauser', '$username', '$password', '$role')");
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" name="namauser" placeholder="Masukkan nama lengkap" />
